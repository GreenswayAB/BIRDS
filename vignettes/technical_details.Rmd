...
Before using the BIRDS package we already have to make some first decisions which data to retrieve and how, and whether to clean the data, as shown in this workflow ![Decision workflow](./vignettes/images/BIRDsDecision.png). 
