...
three basic steps: organising the data into a sampling event-based format, summarising
the data producing summary variables that inform about sampling effort and 
data completeness, and reviewing the summarised variables.
...
grid and create a set of objects that summarise the data spatially, temporally, 
...
We use as an example a dataset consisting of 10k species observations of 
...
You can easily create a grid over a sample area (i.e. `gotaland`), organise and 
summarise the data, and export the variables you want to plot:
...
Then, we can summarise spatial data in some maps, to review, for example, 
...
We could also map the ignorance scores based on the number of visits using the 
